...
void todo(std::string &message, int line) {
  setColor(RED);
  std::cout << message << "At line number" << line << std::endl;
  resetColor();
  std::exit(1);
}
void todo(std::string &message, std::string &funtion_name, int line) {
  setColor(RED);
  std::cout << message << "At line number: " << line << std::endl;
  std::cout << "The funtion that needs to be implemented is: " << funtion_name
            << std::endl;
  resetColor();
  std::exit(1);
}
